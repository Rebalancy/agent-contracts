...
#         current = {1: 5000, 2: 0}
#         optimized = {1: 2000, 2: 3000}
#         expected = [
#             {'from': 1, 'to': 2, 'amount': 3000}
#         ]
#         result = compute_rebalance_operations(current, optimized)
#         self.assertEqual(result, expected)

#     def test_multiple_destinations(self):
#         current = {1: 10000, 2: 0, 3: 0}
#         optimized = {1: 1000, 2: 3000, 3: 6000}
#         expected = [
#             {'from': 1, 'to': 2, 'amount': 3000},
#             {'from': 1, 'to': 3, 'amount': 6000}
#         ]
#         result = compute_rebalance_operations(current, optimized)
#         self.assertEqual(result, expected)

#     def test_intermediate_chain(self):
#         current = {1: 2000, 2: 3000, 3: 5000}
#         optimized = {1: 5000, 2: 3000, 3: 2000}
#         expected = [
...
#         current = {1: 1000, 2: 2000}
#         optimized = {1: 1000, 2: 2000}
#         result = compute_rebalance_operations(current, optimized)
